...
public class SearchTracksAsync extends AsyncTask<String, Void, List<Track>> {
    private static final String METHOD_GET = "GET";
    public static final String NOTIFY_FETCH_FAILED = "Get tracks failed!";
    private static final String SYMBOL_NEW_LINE = "\n";
    private TrackRemoteDataSource.OnGetTracksByQuery mCallbackQuery;

    public SearchTracksAsync(TrackRemoteDataSource.OnGetTracksByQuery callbackQuery) {
    ...
    protected void onPostExecute(List<Track> tracks) {
        if (mCallbackQuery != null) {
            if (tracks == null) {
                mCallbackQuery.onGetTracksFailed(NOTIFY_FETCH_FAILED);
                return;
            }
            mCallbackQuery.onGetTracksSuccess(tracks);
        }
    }
}
